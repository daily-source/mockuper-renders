...
export default new Vuex.Store({
  state: {
    ...
    donations: {
      ...
      topFundraisers: {
        data: [
          { fundraiser_id: 254, nonprofit_ein: 43138428, user_id: 721, amountInCents: 214500, User: { firstName: "Francisca", lastName: "Morana", nickname: "Fran", avatar: { src: `${baseUrl}img/donor-1.jpg` }}, fullname: 'Francisca Morana', firstName: 'Francisca', lastName: 'Morana', avatar: `${baseUrl}img/donor-1.jpg`, createdAt: 1521504544000, public: true, },
          { fundraiser_id: 254, nonprofit_ein: 43138428, user_id: 723, amountInCents: 233500, fullname: 'Andreas Higgins', firstName: 'Andreas', lastName: 'Higgins', User: { avatar: { src: `${baseUrl}img/donor-4.jpg` } }, createdAt: 1539504944000, public: true, },
          { fundraiser_id: 254, nonprofit_ein: 43138428, user_id: 722, amountInCents: 330000, fullname: 'Ariadna Beckenbauer', firstName: 'Ariadna', lastName: 'Beckenbauer', createdAt: 1526504544000, public: true, },
          { fundraiser_id: 254, nonprofit_ein: 43138428, user_id: 725, amountInCents: 132500, fullname: 'Martin Fitzgerald', firstName: 'Martin', lastName: 'Fitzgerald', User: {avatar: { src: `${baseUrl}img/donor-6.jpg` }}, createdAt: 1516504944000, public: true, },
          { fundraiser_id: 254, nonprofit_ein: 43138428, user_id: 726, amountInCents: 215000, fullname: 'Sandra Martignon', firstName: 'Sandra', lastName: 'Martignon', User: {avatar: { src: `${baseUrl}img/donor-10.jpg` }}, createdAt: 1540504944000, public: true, },
          { fundraiser_id: 254, nonprofit_ein: 43138428, user_id: 724, amountInCents: 114000, fullname: 'Luisa Lane', firstName: 'Luisa', lastName: 'Lane', avatar: { src: `${baseUrl}img/donor-5.jpg` }, createdAt: 1536504944000, public: true, },
        ]
      },
      current: 1,
      limit: 2,
