  ...
  data: [
    ...
    },
    {
      ...
      have: [
        ...
        ...haveDefault,
        ...dontHaveDefault.slice(0, 8),
      ],
      dontHave: [...dontHaveDefault.slice(8, dontHaveDefault.length)],
      photos: [
        'top-20-photo-1.jpg',
    ...
    },
    {
      ...
      have: [
        ...
        ...haveDefault.slice(0, 26),
      ],
      dontHave: [...haveDefault.slice(26),...dontHaveDefault],
      photos: [
				'DSC06738.jpg',
    ...
    },
    {
      ...
      have: [
        ...
        ...haveDefault.slice(0, 13),   
      ],
      dontHave: [...haveDefault.slice(13),...dontHaveDefault],
      photos: [
				'ruralindia.jpg',
    ...
    },
    {
      ...
      have: [
        ...
        ...haveDefault.slice(0, 6),        
      ],
      dontHave: [...haveDefault.slice(6),...dontHaveDefault],      
      photos: [
				'makeshift-metal.jpg',
