<template>
  <div class="user-management-page__wrapper">
    ...
    <section class="donations-section">
      <div v-if="userData.donations.length">
            ...
            <tr v-for="donation in userData.donations" :key="donation.id">
              <td>
                <div v-if="donation.fundraiser_id">
                  <router-link :to="`/fundraiser/${donation.fundraiser_id}`">See fundraiser</router-link>
                </div>
                <div v-else>
                  <router-link :to="`/nonprofit/${donation.nonprofit_ein}`">See nonprofit</router-link>
                </div>
              </td>
