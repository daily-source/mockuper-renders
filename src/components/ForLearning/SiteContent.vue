<template>
  <main id="site-content">
    <section class="section has-text-centered intro">
      <div class="container">
        <h4 class="intro__heading">Here is a sampling of our websites for learning about important topics.</h4>
        <router-link to='about' class='is-primary button'>Get Started</router-link>
      </div>
    </section>
