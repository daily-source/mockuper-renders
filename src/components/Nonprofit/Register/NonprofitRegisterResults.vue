<template>
  ...
  >
    ...
    >
      <p class='subheading' v-if='showSubheading'>If your nonprofit is below, click the claim button. If it's already claimed, get the login from your team. If you lost the password, you can reset it here. If you lost the entire login, click Already Claimed.” If it's not in the results, the current profile on our site may have a typo, so please do a 2nd search using other words. If you've already done that, click “Add A New Nonprofit” at the bottom.</p>
      <div 
