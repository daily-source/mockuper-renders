<template>
  <div class="fundraiser-nonprofit-organization__wrapper" v-if="fundraiser.participant">
    <p>A Loseathon is a fundraiser like a walkathon, but rather than walking a certain distance, the person loses a certain amount of weight to raise money for a nonprofit.</p>
