      ...
      <div class="form-wrapper">
        <form v-on:keyup.enter="validateSubmit()">
          ...
          <div class='form-details' >
            <p>
              <span class='has-text-weight-bold'>WEB DEVELOPER:</span> when the fundraising activity is done at the nonprofit profile page, copy it here.
            </p>
            <p v-if='showAlsoSection'>
              <span class='has-text-weight-bold'>ALSO:</span> in the heading above where it says "Start Your Own Fundraiser,” delete the word “Fundraiser” and replace it with the name of the fundraiser at this website.
            </p>
            <p v-if='showAlsoSection'>
              For example: Start Your Own Volunteerathon.
            </p>
          </div>
