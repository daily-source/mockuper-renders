<template>
  ...
  >
    ...
    <transition name='box-slider-fade'>
			<div 
...
// Fade animation
.box-slider-fade-enter,
.box-slider-fade-leave-to {
  opacity: 0;
}

.box-slider-fade-enter-active,
.box-slider-fade-leave-active {
  transition: opacity .2s ease-out;
}

.box-slider-fade-enter-to,
.box-slider-fade-enter-leave {
  opacity: 1;
}
</style>
