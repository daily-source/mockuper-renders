<template>
  <div class="">
    ...
    >
      <div slot="heading"><h2>Who's doing a Charitable Contest to raise money for this nonprofit?</h2></div>
    </NonprofitFundraisers>
...
export default {
  ...
  components: {
    ...
    AppHeader: () => import('Components/CharitableContests/AppHeader.vue'),
