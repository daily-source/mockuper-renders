<template>
  <div class="fundraiser">
    ...
    >
      <p slot="copytext">
        {{fundraiser.User.firstName}} will join the attempt to break the world's most trees planted within 24 hours to raise money for <router-link :to='`/nonprofit/${fundraiser.Nonprofit.EIN}`'>{{ fundraiser.Nonprofit.NAME }}</router-link>.
      </p>
      <span slot="effortstext">Please sponsor {{fundraiser.User.firstName}}'s Records for Good</span>
    </FundraiserHero>
...
import AppHeader from 'Components/RecordsForGood/AppHeader.vue';
