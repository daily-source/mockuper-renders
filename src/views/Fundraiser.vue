<template>
  <div class="fundraiser">
    ...
    >
      <p slot="copytext">
        {{fundraiser.User.firstName}} will give up candies for 2 months to raise money for <router-link :to='`/nonprofit/${fundraiser.Nonprofit.EIN}`'>{{ fundraiser.Nonprofit.NAME }}</router-link>.
      </p>
      <span slot="effortstext">Please sponsor {{fundraiser.User.firstName}}'s Daily Indulgence Drop</span>
    </FundraiserHero>
