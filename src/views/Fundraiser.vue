<template>
  <div class="fundraiser">
    ...
    >
      <p slot="copytext">
        {{fundraiser.User.firstName}} will do charity work for their anniverary to raise money for <router-link :to='`/nonprofit/${fundraiser.Nonprofit.EIN}`'>{{ fundraiser.Nonprofit.NAME }}</router-link>.
      </p>
      <span slot="effortstext">Please sponsor {{fundraiser.User.firstName}}'s Altruistic Anniversary</span>
    </FundraiserHero>
...
import AppHeader from 'Components/AltruisticAnniversaries/AppHeader.vue';
