<template>
  <div class="fundraiser">
    ...
    >
      <p slot="copytext">
        {{fundraiser.User.firstName}} will host a Donate-a-thon to raise money for for <router-link :to='`/nonprofit/${fundraiser.Nonprofit.EIN}`'>{{ fundraiser.Nonprofit.NAME }}</router-link>.
      </p>
      <span slot="effortstext">Please sponsor {{fundraiser.User.firstName}}'s Donate-a-thon</span>
    </FundraiserHero>
...
export default {
   ...
   */
  components: {
    AppHeader: () => import('Components/Donateathon/AppHeader.vue'),
