<template>
  <div class="fundraiser">
    ...
    >
      <p slot="copytext">
        {{fundraiser.User.firstName}} will swim at least 3 kilometers through the English Channel to raise money for <router-link :to='`/nonprofit/${fundraiser.Nonprofit.EIN}`'>{{ fundraiser.Nonprofit.NAME }}</router-link>.
      </p>
      <span slot="effortstext">Please sponsor {{fundraiser.User.firstName}}'s Charitable Challenge</span>
    </FundraiserHero>
...
export default {
   ...
   */
  components: {
    AppHeader: () => import('Components/CharitableChallenges/AppHeader.vue'),
