<template>
  <div class="fundraiser">
    ...
    >
      <p slot="copytext">
        {{fundraiser.User.firstName}} will spend her next birthday benevolently to raise money for <router-link :to='`/nonprofit/${fundraiser.Nonprofit.EIN}`'>{{ fundraiser.Nonprofit.NAME }}</router-link>.
      </p>
      <span slot="effortstext">Please sponsor {{fundraiser.User.firstName}}'s Benevolent Birthday</span>
    </FundraiserHero>
...
export default {
   ...
   */
  components: {
    AppHeader: () => import('Components/BenevolentBirthdays/AppHeader.vue'),
