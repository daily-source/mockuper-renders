<template>
  <div class="fundraiser">
    ...
    >
      <p slot="copytext">
        {{fundraiser.User.firstName}} will spend her vacation doing volunteer work to raise money for <router-link :to='`/nonprofit/${fundraiser.Nonprofit.EIN}`'>{{ fundraiser.Nonprofit.NAME }}</router-link>.
      </p>
      <span slot="effortstext">Please sponsor {{fundraiser.User.firstName}}'s Virtuous Vacation</span>
    </FundraiserHero>
...
import AppHeader from 'Components/VirtuousVacations/AppHeader.vue';
