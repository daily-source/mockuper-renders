  ...
  <div class="explore__wrapper" :class="`version${version}`">
    <div  v-if="!version || version === 1">
      ...
      <section class="examples__section-wrapper">
        <div class="container">
          <h1 class="section-title title">Examples of Grow One for Good done to raise money</h1>
      ...
      >
        <div slot="heading"><h1 class="section-title title title-blue has-text-centered">Start Your Own Fundraiser</h1></div>
      </nonprofit-form>
    ...
    <div  v-if="version === 2">
      ...
      >
        <div slot="heading"><h1 class='has-text-centered'>Start Your Own Volunteerathon</h1></div>
      </nonprofit-form>
